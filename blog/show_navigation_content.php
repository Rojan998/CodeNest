...
<div class="container">
  <div class="row">
	...
	<div class="col-lg-8">
	  ...
	  if(isset($_GET['navigation_name'])){
	  	$post_navigation_name = $_GET['navigation_name'];
	  }
	 

		$query                  = "SELECT * FROM posts WHERE post_title LIKE '%$post_navigation_name%'"; //this is mistake
